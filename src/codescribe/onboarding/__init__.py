"""Onboarding wizard for CodeScribe first-run experience."""
...
class OnboardingWizard:
    ...
    def _step_permissions(self) -> None:
        resp = self._nsalert(
            "Permissions",
            "CodeScribe needs Accessibility, Input Monitoring, and Microphone permissions. "
        ...
        if resp == AppKit.NSAlertFirstButtonReturn:
            ...
            self._nsalert(
                ...
                "Microphone. Enable CodeScribe (or your preferred terminal) in each list, then "
                "click Continue.",
                ["Continue"],
            )
...
"""
    ...
    def _persist(self) -> None:
        ...
        if self._result.ai_api_key and self._bundled:
            self._store_keychain_secret("CodeScribeAIKey", self._result.ai_api_key)
