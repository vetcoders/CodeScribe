...
pub use voice_chat_ui::{
    ...
    refresh_drawer, send_voice_chat_draft, set_voice_chat_send_callback, set_voice_chat_sending,
    set_voice_chat_text, set_voice_chat_user_text, show_agent_tab, show_drawer_tab,
    show_settings_tab, show_voice_chat_overlay, show_voice_chat_overlay_with_config,
