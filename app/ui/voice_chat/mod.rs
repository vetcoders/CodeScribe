...
pub use api::{
    ...
    request_settings_tab_on_open, send_voice_chat_draft, set_voice_chat_send_callback,
...
fn show_voice_chat_overlay_impl() {
    unsafe {
        ...
        style_tafla_sidebar_tint(sidebar_view);
        ...
        style_tafla_section(content_view);
