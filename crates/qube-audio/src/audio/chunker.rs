...
impl SpeechSession {
    ...
    pub fn segment_speech_prob(&self) -> f32 {
    ...
    pub fn take_event_speech_vad_samples(&mut self) -> u64 {
        self.event_speech_vad_samples.pop_front().unwrap_or(0)
    }

    pub fn take_vad_error_stats(&mut self) -> Option<VadErrorStats> {
...
#[allow(dead_code)]
pub fn hardcoded_gate_config() -> GateConfig {
...
pub fn hardcoded_utterance_gate_config() -> GateConfig {
...
pub fn init_silero_vad(sample_rate: u32, config: &vad::VadConfig) -> Option<vad::SileroVad> {
